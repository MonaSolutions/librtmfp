...
#elif defined(_BSD)
#define		FATAL_ERROR(...)				{  __assert(NULL, __FILE__,__LINE__, Base::String(__VA_ARGS__).c_str()); }
#else
#define		FATAL_ERROR(...)				{  __assert_fail(Base::String(__VA_ARGS__).c_str(),__FILE__,__LINE__,NULL); }
#endif
#endif
